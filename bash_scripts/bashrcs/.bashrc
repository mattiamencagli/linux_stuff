...
#if git do not works properly activate this
#source .bash_git
...
if [ "$color_prompt" = yes ]; then
	...
	color_host='\[\e[01;35m\]@\h' #use this on other machines
...
#alias blankscreen='sleep 1 ; xset dpms force off'
#alias clipboard_clean='xsel -bc'
#alias citrix_check='/opt/Citrix/ICAClient/util/hdxcheck.sh'
